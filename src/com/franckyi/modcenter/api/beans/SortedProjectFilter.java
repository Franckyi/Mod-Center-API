...
/**
 * <p>
 * The filter used in API queries on {@link Project}s that needs a sort order. It has all the informations from a {@link ProjectFilter}, and it also defines how the
 * results are sorted and in which direction, where :
 * </p>
 * <ul>
